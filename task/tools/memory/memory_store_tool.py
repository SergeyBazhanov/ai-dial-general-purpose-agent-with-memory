...
class StoreMemoryTool(BaseTool):
    ...
    def description(self) -> str:
        return (
            "Stores a long-term memory about the user. Use this tool whenever the user shares personal information, "
            "preferences, facts about themselves, goals, plans, or any important context. Each memory should be a "
            "clear, concise fact. Store each distinct piece of information as a separate memory. "
            "Do NOT wait to be asked — proactively store any new user facts immediately. "
            "Do NOT store duplicate or already-known information."
        )
